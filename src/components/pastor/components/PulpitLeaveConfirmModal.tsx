...
export interface PulpitLeaveConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export const PulpitLeaveConfirmModal: React.FC<PulpitLeaveConfirmModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
}) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="leave-pulpit-title"
    >
      <div className="bg-white rounded-2xl max-w-md w-full p-5 sm:p-6 shadow-2xl border border-church-sand space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 id="leave-pulpit-title" className="font-title text-base font-bold text-church-charcoal uppercase">
