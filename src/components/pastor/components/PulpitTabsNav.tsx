...
export const PulpitTabsNav: React.FC<PulpitTabsNavProps> = ({
  ...
  return (
    <header className="bg-white border-b-2 border-church-sand px-2 sm:px-4 py-2 sm:py-2.5 shrink-0 shadow-xs select-none">
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto flex items-center justify-between gap-1.5 sm:gap-3">
        ...
        {/* 4 Botões da Faixa Superior com Altura Tátil Confortável */}
        <nav className="flex items-center gap-1.5 sm:gap-2.5 flex-1 justify-center sm:justify-start" aria-label="Abas do Púlpito">
          ...
          >
            ...
            <span>Orações</span>
            <span
              className={`px-1.5 py-0.5 rounded-full text-[10px] sm:text-xs font-mono font-bold ${
